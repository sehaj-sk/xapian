...
cout << "Link Grammar library not found" << endl;
exit(1);
#else
    ...
    cout << "The Linkage Diagram for the given sentence:" << endl;
    cout << pos_tagger.get_linkage_diagram_string(line) << endl;

    cout << "The words and their corresponding POS are:" << endl;
    cout << pos_tagger.get_pos_description_string(line) << endl;

    cout << "The constituent tree structure is:" << endl;
    cout << pos_tagger.get_constituent_tree_string(line) << endl;
